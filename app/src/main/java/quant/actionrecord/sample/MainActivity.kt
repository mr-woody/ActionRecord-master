...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById(R.id.button1).setOnClickListener { startActivity(Intent(this@MainActivity, SampleActivity1::class.java)) }
        findViewById(R.id.button2).setOnClickListener { startActivity(Intent(this@MainActivity, SampleActivity2::class.java)) }
